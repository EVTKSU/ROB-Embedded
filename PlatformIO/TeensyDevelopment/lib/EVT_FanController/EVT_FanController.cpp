...
FanController::FanController() {
  Serial.begin(9'600);           // Start the serial monitor
...
void FanController::propTempControl() {
  /**
   * Replace with proportional control:
   *   1. Make the fan speed scale linearly to the temperature by some constant
   *   2. Use the temperature value as the input value and control the duty cycle
  **/
